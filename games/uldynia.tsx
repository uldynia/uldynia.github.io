...
export default function UldyniaContent() {
    return (
        <>
            ...
            <Row>
                <ActionButton icon="https://www.iconpacks.net/icons/1/free-linkedin-icon-130-thumb.png" href="https://www.linkedin.com/in/uldynia/">Hire on LinkedIn</ActionButton>
